const itemList = jQuery.parseJSON(`{ "caseList" : }`);

var allObjects = itemList.caseList.length;
var n = 29;
...
for (let e = 0; e < allObjects; e++) {
        ...
        `);
        $('.object-name')[e].innerHTML = itemList.caseList[e].name;
        $('.object-img')[e].src = itemList.caseList[e].imglink;
}
