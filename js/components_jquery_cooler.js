const itemList = jQuery.parseJSON(`{ "coolerList" : }`);

var allObjects = itemList.coolerList.length;
var n = 29;
...
for (let e = 0; e < allObjects; e++) {
        ...
        `);
        $('.object-name')[e].innerHTML = itemList.coolerList[e].name;
        $('.object-img')[e].src = itemList.coolerList[e].imglink;
}
