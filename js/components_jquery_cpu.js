const itemList = jQuery.parseJSON(`{ "cpuList" : [
    {
     "number": 1,
     "scope": "desktop",
     "brand": "AMD",
...
for (let e = 0; e < allObjects; e++) {
        ...
        `);
        $('.object-name')[e].innerHTML = itemList.cpuList[e].brand + ' ' + itemList.cpuList[e].serie + ' ' + itemList.cpuList[e].sottoseria + ' ' + itemList.cpuList[e].name;
        $('.object-img')[e].src = itemList.cpuList[e].imglink;
}
