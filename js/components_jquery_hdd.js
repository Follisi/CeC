const itemList = jQuery.parseJSON(`{ "hddList" : }`);

var allObjects = itemList.hddList.length;
var n = 29;
...
for (let e = 0; e < allObjects; e++) {
        ...
        `);
        $('.object-name')[e].innerHTML = itemList.hddList[e].name;
        $('.object-img')[e].src = itemList.hddList[e].imglink;
}
