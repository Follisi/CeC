const itemList = jQuery.parseJSON(`{ "mbList" : }`);

var allObjects = itemList.mbList.length;
var n = 29;
...
for (let e = 0; e < allObjects; e++) {
        ...
        `);
        $('.object-name')[e].innerHTML = itemList.mbList[e].name;
        $('.object-img')[e].src = itemList.mbList[e].imglink;
}
