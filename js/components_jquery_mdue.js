const itemList = jQuery.parseJSON(`{ "mdueList" : }`);

var allObjects = itemList.mdueList.length;
var n = 29;
...
for (let e = 0; e < allObjects; e++) {
        ...
        `);
        $('.object-name')[e].innerHTML = itemList.mdueList[e].name;
        $('.object-img')[e].src = itemList.mdueList[e].imglink;
}
