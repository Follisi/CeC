const itemList = jQuery.parseJSON(`{ "ssdList" : }`);

var allObjects = itemList.ssdList.length;
var n = 29;
...
for (let e = 0; e < allObjects; e++) {
        ...
        `);
        $('.object-name')[e].innerHTML = itemList.ssdList[e].name;
        $('.object-img')[e].src = itemList.ssdList[e].imglink;
}
